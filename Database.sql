CREATE DATABASE  IF NOT EXISTS `al_ain` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `al_ain`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: al_ain
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'al_ain'
--
